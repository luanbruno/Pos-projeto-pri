		...
		try {
			...
			try {
				...
				while (linha != null) {
					...
					case "A":
						try {
							Aditivo aditivo = new Aditivo("aditivo de radiador", "acdelco", 43);
					...
					case "B":						
						try {
							Bateria bateria = new Bateria("bateria de moto", "moura", 123);
					...
					case "L":
						try {
							Lubrificante lubrificante = new Lubrificante("oleo e motor", "petronas", 18);
							lubrificante.setMotor(campos[1]);;
